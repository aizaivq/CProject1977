...
enum AVPacketSideDataType {
    ...
    /**
     * The GPS information about this packet, the gps format is :
     * int utctime[ms]
     * int latitude * 1000000;
     * int longitude * 1000000;
     * int combine [altitude/bearing/speed]
     */
    AV_PKT_DATA_GPS_INFO
};
...
typedef struct AVPacket {
     ...
     */
    int64_t dts;
    int64_t absolute_unix_time;     //seconds from 1970-01-01
    uint8_t *data;
    int   size;
    int   stream_index;
    /**
...
#define AV_PKT_FLAG_ABSOLUTE_TIME 0x80000000 ///< The packet is absolute time packet
#define AV_PKT_FLAG_SWITCH_DATASOURCE_REQUEST 0x40000000 ///< The packet is end packet of cloudserver/p2p, will switch to p2p/cloudserver immediately
