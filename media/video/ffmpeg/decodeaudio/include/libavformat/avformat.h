...
#define AVFMT_FLAG_QUICK_PARSE    0x80000000 ///< skip the avformat_find_stream_info asap

#define AVFMT_FLAG_FAST_PROBE       0x10000000///< Fast probe
#define AVFMT_FLAG_FAST_VIDEO_PROBE 0x20000000///< return when get first video stream
#define AVFMT_FLAG_MP4_PANORAMA_VIDEO 0x40000000///< return when get first video stream
    /**
